 ...
 * to configure your Sails app for  jobmanager.  The configuration in this file
 * is only used in your  jobmanager environment, i.e. when you lift your app using:
 *
 * ```
 * NODE_ENV= jobmanager node app
 * ```
 *
